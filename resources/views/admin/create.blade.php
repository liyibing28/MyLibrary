...
@section('page_title')
    <div class="section section-breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-md-12" >
                    <h1>&nbsp&nbsp&nbsp&nbsp&nbsp录入书籍</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row" >
                <div class="col-sm-5" style="margin-left:350px" >
                    <div class="basic-login" >
                        <form  enctype="multipart/form-data" role="form" method="POST" name="uploadform" action="{{ url('/admin/create') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label for="title"><i class="icon-user"></i><b>书本信息</b></label>
                            </div>
